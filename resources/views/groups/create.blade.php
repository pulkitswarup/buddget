                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="name" value="{{ old('name') }}" required autofocus placeholder="Specify the name of the group">
                        ...
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea name="description" class="form-control" rows="5" placeholder="Specify some description about the group">{{ old('description') }}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('share') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="share" type="text" class="form-control" name="share" value="{{ old('share') }}" placeholder="Enter email addresses...">
